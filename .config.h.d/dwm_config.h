...
static const char col_cyan[]        = "#2f676a";
...
static const Key keys[] = {
	...
	{ MODKEY, XK_p,                spawn, SHCMD("scr") },
	{ MODKEY, XK_e,                spawn, SHCMD("openmenu") },
	{ MODKEY, XK_t,                spawn, SHCMD("tmux-here-menu") },
	...
	{ MODKEY, XK_o,                spawn, SHCMD("bright up") },
	{ MODKEY|ShiftMask, XK_o,      spawn, SHCMD("bright down") },
	{ MODKEY, XK_equal,            spawn, SHCMD("volume up") },
	{ MODKEY, XK_minus,            spawn, SHCMD("volume down") },
	{ MODKEY, XK_BackSpace,        spawn, SHCMD("volume mute") },
	{ MODKEY, XK_Return,           spawn, SHCMD("playerctl play-pause") },
	{ MODKEY, XK_bracketright,     spawn, SHCMD("playerctl next") },
	{ MODKEY, XK_bracketleft,      spawn, SHCMD("playerctl previous") },
	{ MODKEY|ShiftMask, XK_BackSpace, spawn, SHCMD("playerctl stop") },
};
